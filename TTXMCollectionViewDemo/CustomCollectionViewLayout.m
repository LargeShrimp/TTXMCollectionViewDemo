...
//    }    
    switch (indexPath.row) {
        ...
        case 1:
        {
             attributes.frame = CGRectMake(SCREEN_WIDTH / 2+1, 0, itemWidth, itemHeight);
        }
            break;
        case 2:
        {
            attributes.frame = CGRectMake(SCREEN_WIDTH / 2+1, itemHeight + 1, itemWidth, itemHeight);

        }
            break;
        case 3:
        {
            attributes.frame = CGRectMake(SCREEN_WIDTH / 4 * 3+2, itemHeight + 1, itemWidth, itemHeight);
